          ...
          <AnimatePresence>
            {showComplexity && (
              ...
              >
                ...
                >
                  {/* Modal Header */}
                  <div className="sticky top-0 bg-gradient-to-r from-rose-400 to-pink-400 border-b-4 border-ink p-6 flex items-center justify-between z-10">
                  ...
                  {/* Modal Content */}
                  <div className="p-6">
                    <ComplexityGraph topicSlug={topic?.meta.slug} />
                  </div>
